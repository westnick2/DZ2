...
when "14"
  ...
  print "Input num r: "
  r = gets.chomp
  rezult = DZClass.dz14(m1.to_f,m2.to_f,r.to_f)
when "15"
  print "Input gipotenuza a: "
  a = gets.chomp
  print "Input katet b: "
  b = gets.chomp
  rezult = DZClass.dz15(a.to_f,b.to_f)
when "16"
  print "Input dlina okruzhnosti p: "
  p = gets.chomp
  rezult = DZClass.dz16(p.to_f)
when "17"
  r1 =20
...
when "18"
  ...
  print "Input radius:"
  r = gets.chomp
  rezult = DZClass.dz18(alpha.to_f,beta.to_f,gama.to_f,r.to_f)
when "19"
  print "Input num v1: "
  v1 = gets.chomp
  print "Input num v2: "
